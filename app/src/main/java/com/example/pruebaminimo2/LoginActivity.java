...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            mAuthTask = null;
            showProgress(false);
//esto te lo da el profe, si es success, pues hacecs un newIntent que basicamente es abrir otro activity
            if (success) {
        ...
        //Esto es para llamar otro activity que se llamará MainAcitvity
    }
